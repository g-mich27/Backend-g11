...
SECRET_KEY = 'django-insecure-2axmkkpld*i-l)0nwll)mp)wfb5ef7#u!vm%!b+5_0x#9^f3u%'
...
DATABASES = {
    'default': {
        ...
        'HOST': 'localhost',    # el host donde se ubica mi base de datos
        'USER': 'postgres',     # el usuario de la base de datos
        'PASSWORD': 'sql2023',     # la contraseña de la base de datos
