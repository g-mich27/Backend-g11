...
flask_api.add_resource(UnNivelController,'/niveles/<id>')
flask_api.add_resource(MaestroController, '/maestros')
flask_api.add_resource(UnMaestroController, '/maestros/<id>')
